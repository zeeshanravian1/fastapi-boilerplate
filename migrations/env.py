...
from fastapi_boilerplate.database.connection import my_metadata
from fastapi_boilerplate.database.init_database import (
    create_roles,
    create_super_admin,
)
...
config.set_main_option("sqlalchemy.url", core_configuration.DATABASE_URL)
